...
def mobile_api_info():
    ...
    return {
        ...
        "oauth_config": {
            ...
            "auth_endpoint": base_url + auth_config.get('ticktix_authorize_url', '/oauth/v2/authorize'),
            "token_endpoint": base_url + auth_config.get('ticktix_token_url', '/oauth/v2/token'),
